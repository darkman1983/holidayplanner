    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form name="loginFrm" role="form" action="<?php echo @$viewModel->get('BaseUrl'); ?>test.php" method="post">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="psw" placeholder="Passwort Eingeben">
            </div>
            <div class="checkbox">
